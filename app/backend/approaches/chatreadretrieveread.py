...
class ChatReadRetrieveReadApproach(Approach):
    ...
    async def run_without_streaming(
        ...
        # CUSTOM: Phase 2 - use response.usage (Responses API); preserve fork's
        # enhanced_citations and citation_map keys in context for frontend compatibility.
        ...
        chat_app_response = {
            "output_text": content,
            # CUSTOM: Preserve legacy non-streaming shape for older clients while
            # also returning the upstream Responses API field expected by the new frontend.
    ...
    async def run_until_final_call(
        ...
        # CUSTOM: dual-flag support. Frontend may send either name during transition.
